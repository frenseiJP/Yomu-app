  ...
  const [lines, setLines] = useState<ChatLine[]>([
    {
      id: 1,
      role: "assistant",
      text: "Hi, I'm Frensei. Ask about any Japanese phrase—meaning, culture, or how to sound natural. You have 3 free messages.",
    },
  ]);
      ...
      {shareUrl ? (
        <div className="border-t border-slate-800/80 px-4 py-2">
          ...
          >
            ...
            {shareCopied ? "Link copied!" : "Share this correction"}
          </button>
        </div>
      ) : null}
