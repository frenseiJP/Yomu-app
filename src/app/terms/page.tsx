...
const articles = [
  ...
  },
  {
    title: "第3条 免責事項（重要）",
    body: [
      "3-1 AIの回答精度に関する免責: Frenseiが提供するAIによる日本語学習支援（文法解説・翻訳・発音アドバイス・例文生成等）は参考情報として提供されるものです。その内容の正確性・完全性・最新性を当社は一切保証しません。特に試験・資格取得・業務上の重要な判断では、必ず有資格の専門家または公式教材にてご確認ください。",
  ...
  },
  {
    ...
    body: [
      "当社は、利用者の個人情報を別途定める「Frenseiプライバシーポリシー」に従い適切に取り扱います。ベータ版においては、サービス改善を目的として利用者の学習ログ・AIとの会話データを収集・分析する場合があります。",
    ],
  },
  {
    title: "第7条 規約の変更",
    ...
    <div className="min-h-screen bg-[#020617] text-slate-100">
      <main id="top" className="mx-auto w-full max-w-4xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
        <section className="rounded-3xl border border-pink-400/60 bg-slate-950/90 p-6 shadow-[0_20px_70px_rgba(236,72,153,0.16)] sm:p-8">
          <p className="text-xs tracking-[0.18em] text-pink-200">FRENSEI BETA TERMS</p>
          ...
          <p className="mt-5 text-sm leading-relaxed text-slate-200">
            ご利用前に必ずお読みください。本サービス「Frensei」はベータ版（試験提供段階）のAIサービスです。
        ...
        <section className="mt-8 rounded-2xl border border-pink-500/40 bg-slate-950/90 p-5 sm:mt-10 sm:p-6">
          <p className="text-sm leading-7 text-slate-200">
            お問い合わせ：Frensei サポート窓口（frensei.jp@gmail.com）<br />
