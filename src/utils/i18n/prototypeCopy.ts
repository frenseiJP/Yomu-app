...
const SETTINGS_EN: PrototypeSettingsText = {
  ...
  appearance: "Screen tone",
  appearanceDesc: "Choose a calm dark tone or a bright white tone.",
  themeDark: "Dark",
  themeLight: "Light",
...
const UI_EN: PrototypeUiText = {
  ...
  noRecentWords:
    "Your notebook is ready. Save a word from chat, and your learning trail starts here.",
  missionCompleted: "Completed",
  streakToday: "Today",
  streakDayOtherTemplate: "Day {n}",
  growthLogTitle: "Growth journal",
  growthLogSubtitle:
    "A calm view of what you practiced, what improved, and what to try next.",
  recordEmptyTitle: "You're ready to begin",
  recordEmptyBody:
    "When a phrase feels useful, save it from chat. Even one saved expression is meaningful progress.",
  recordEmptyCta: "Open chat and save one helpful phrase",
  patternStreakLabel: "Steady streak",
  daysShort: "days",
  studiedThisWeekCaption: "Days you studied this week",
  skillChartTitle: "Skill chart · four axes",
  skillVocabTitle: "Vocabulary",
  skillVocabDesc: "Based on the words and expressions you chose to keep.",
  skillNaturalTitle: "Naturalness",
  skillNaturalDesc:
    "Reflects consistency and your growing feel for natural Japanese.",
  skillGrammarTitle: "Grammar",
  skillGrammarDesc:
    "Shows grammar growth from the patterns you've practiced.",
  skillPaceTitle: "Pace",
  skillPaceDesc: "Shows your current learning rhythm at your chosen pace.",
  myVocabularyHeading: "My vocabulary",
  vocabSavedLine: "{n} words saved",
  savedOnPrefix: "Saved",
  weekCheerTitle: "Coach note for this week",
  weekCheerTemplate:
    "You saved {n} {words} this week. That's real progress. Add one tiny real-life usage note to each phrase, and confidence will keep growing.",
  ...
  jlptLevelDesc: "Sensei matches example difficulty to your target level.",
  ...
  quickPrompt1: "How do I order food politely?",
  quickPrompt2: "What does お疲れ様 mean?",
  quickPrompt3: "How do Japanese people say no politely?",
...
const SETTINGS_JA: PrototypeSettingsText = {
  ...
  section: "表示 / 言語 / 地域",
  appearance: "画面トーン",
  appearanceDesc: "落ち着いた暗め表示と、白基調の明るい表示を選べます。",
  themeDark: "暗い",
  themeLight: "明るい",
  basicLanguage: "表示言語",
...
const UI_JA: PrototypeUiText = {
  ...
  recentWords: "最近の語彙",
  noRecentWords:
    "ここから学習の足あとが始まります。チャットで1つ保存すると、最初の記録が残ります。",
  missionCompleted: "完了",
  streakToday: "今日",
  streakDayOtherTemplate: "第{n}日",
  growthLogTitle: "成長ジャーナル",
  growthLogSubtitle:
    "できたこと・伸びていること・次に試すことを、やさしく振り返る場所です。",
  recordEmptyTitle: "最初の一歩を始めましょう",
  recordEmptyBody:
    "使ってみたい表現を1つ保存するだけで十分です。小さな積み重ねが、自然な日本語につながります。",
  recordEmptyCta: "チャットを開いて1つ保存する",
  patternStreakLabel: "継続ストリーク",
  daysShort: "日",
  studiedThisWeekCaption: "今週学習した日数",
  skillChartTitle: "スキルチャート · 4軸",
  skillVocabTitle: "語彙",
  skillVocabDesc: "あなたが残した語彙・表現から、積み上がりを見ています。",
  skillNaturalTitle: "自然さ",
  skillNaturalDesc: "継続日数と語感の伸びをもとに、自然さの変化を見ています。",
  skillGrammarTitle: "文法",
  skillGrammarDesc: "練習した文の型から、文法の安定度を見ています。",
  skillPaceTitle: "ペース",
  skillPaceDesc: "今の学習ペースに合わせた、無理のない進み方を示します。",
  myVocabularyHeading: "マイ語彙",
  vocabSavedLine: "{n}語を保存",
  savedOnPrefix: "保存",
  weekCheerTitle: "今週のコーチメモ",
  weekCheerTemplate:
    "今週は{n}語を保存できました。着実に進んでいます。各表現に「どんな場面で使うか」をひとこと添えると、自信がさらに育ちます。",
  weekCheerWordOne: "",
  weekCheerWordMany: "",
  ...
  jlptLevelDesc: "例文の難易度を目標レベルに合わせます。",
  ...
  quickPrompt1: "丁寧に食事を注文するには？",
  quickPrompt2: "「お疲れ様」ってどういう意味？",
  quickPrompt3: "断り方を自然に言うには？",
  chatSuggestedFollowUps:
...
const SETTINGS_KO: PrototypeSettingsText = {
  ...
  section: "표시 / 언어 / 지역",
  appearance: "화면 톤",
  appearanceDesc: "차분한 어두운 톤과 밝은 흰색 톤 중에서 선택합니다.",
  themeDark: "어둡게",
  themeLight: "밝게",
  basicLanguage: "표시 언어",
...
const UI_KO: PrototypeUiText = {
  ...
  jlptLevelDesc: "예문 난이도를 목표 레벨에 맞춥니다.",
  ...
  quickPrompt1: "정중하게 음식 주문하려면?",
  quickPrompt2: "「お疲れ様」은 무슨 뜻이에요?",
  quickPrompt3: "일본 사람들은 어떻게 정중하게 거절해요?",
  chatSuggestedFollowUps:
...
const SETTINGS_ZH: PrototypeSettingsText = {
  ...
  section: "显示 / 语言 / 地区",
  appearance: "画面色调",
  appearanceDesc: "可选择沉稳深色或白色为主的明亮色调。",
  themeDark: "深色",
  themeLight: "浅色",
  basicLanguage: "显示语言",
...
const UI_ZH: PrototypeUiText = {
  ...
  quickPrompt1: "如何礼貌地点餐？",
  quickPrompt2: "「お疲れ様」是什么意思？",
  quickPrompt3: "日本人如何礼貌地拒绝？",
