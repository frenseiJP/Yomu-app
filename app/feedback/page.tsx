    ...
    <div className="min-h-screen bg-[#020617] text-slate-100">
      <main className="mx-auto w-full max-w-2xl px-4 py-8 sm:px-6 sm:py-10">
        <section className="rounded-3xl border border-pink-400/60 bg-slate-950/90 p-6 shadow-[0_20px_70px_rgba(236,72,153,0.18)] sm:p-8">
          <p className="text-xs tracking-[0.18em] text-pink-200">BETA · FRENSEI</p>
          <h1 className="mt-2 font-wa-serif text-2xl font-semibold text-slate-50 sm:text-3xl">
            Beta feedback
          </h1>
          <p className="mt-3 text-sm leading-relaxed text-slate-200">
            Thank you for trying Frensei beta. Tell us about bugs, confusing moments, and ideas that
            would help you sound more natural in Japanese. We use your comments to improve the app.
          </p>
        </section>
        ...
        <p className="mt-8 text-center text-xs text-slate-500">
          <Link href="/privacy" className="text-pink-300/90 hover:text-pink-200 underline-offset-2 hover:underline">
            Privacy policy
          </Link>
        </p>
