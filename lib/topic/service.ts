...
export const TOPIC_PROMPTS: TopicPrompt[] = [
  {
    ...
    dailyQuestion: "How do you apologize politely?",
    prompt: "You are 10 minutes late to a meeting. How would you apologize politely in Japanese?",
    category: "apology",
    difficulty: "beginner",
  },
  {
    ...
    prompt: "You cannot find the station exit. How would you ask for help politely in Japanese?",
    category: "asking_help",
    difficulty: "beginner",
  },
  {
    id: "ordering_restaurant",
    title: "Ordering at a restaurant",
    prompt: "You are ready to order. How would you order politely in Japanese?",
    category: "restaurant",
    difficulty: "beginner",
  },
  {
    id: "saying_no_politely",
    title: "Saying no politely",
    prompt: "A coworker invites you but you cannot join. How would you decline politely in Japanese?",
    category: "other",
    difficulty: "beginner",
  },
  {
    ...
    prompt: "You are meeting someone for the first time. Give a short natural self introduction in Japanese.",
    category: "self_introduction",
    difficulty: "beginner",
  },
  {
    id: "asking_spicy",
    title: "Asking if something is spicy",
    prompt: "At a restaurant, how would you ask if a dish is spicy in natural Japanese?",
    category: "restaurant",
    difficulty: "beginner",
  },
];
